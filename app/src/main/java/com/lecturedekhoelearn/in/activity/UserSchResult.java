...
import com.lecturedekhoelearn.in.adapter.UserScholarAdapter;
...
public class UserSchResult extends AppCompatActivity {
        ...
        allNotificationModelCall.enqueue(new Callback<ScholarShipModel>() {
            ...
            public void onResponse(Call<ScholarShipModel> call, Response<ScholarShipModel> response) {
                if (response.body().getStatus().equals(1)) {
                    ...
                    UserScholarAdapter analysisAdapter = new UserScholarAdapter(getApplication(), notificationDetailsModels);
                    ...
                    hideDialog();
                    Toast.makeText(UserSchResult.this, "No Scholarship List Found", Toast.LENGTH_SHORT).show();
