...
public class SignupOtpActivity extends AppCompatActivity {
    ...
    public void getMobileNumber() {
        Call<ChangedMobileNumber> topicsCall = Api_Client.getInstance().getOtp(str_phone,auto_hash);
        topicsCall.enqueue(new Callback<ChangedMobileNumber>() {
            ...
            public void onResponse(@NotNull Call<ChangedMobileNumber> call, @NotNull Response<ChangedMobileNumber> response) {
                ...
                try {
                    if (response.body().getStatus().equals(1)) {
                        ...
                        Intent intent = new Intent(SignupOtpActivity.this, OtpVerifyforSignup.class);
                    ...
                    Toast.makeText(SignupOtpActivity.this,e.toString(),Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<ChangedMobileNumber> call, Throwable t) {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(SignupOtpActivity.this, "network failure: Please check your Internet connection", Toast.LENGTH_SHORT).show();
