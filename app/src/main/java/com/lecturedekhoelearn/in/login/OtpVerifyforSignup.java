...
public class OtpVerifyforSignup extends AppCompatActivity implements
    ...
    Handler handler;
    public static final String TAG = OtpVerifyforSignup.class.getSimpleName();
        ...
        findViewById(R.id.fab).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (otpnN0.equals(preOtp)) {
                    Toast.makeText(OtpVerifyforSignup.this, "OTP is Correct", Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(OtpVerifyforSignup.this, SignupActivity.class);
                    startActivity(i);
                    finish();

                } else {
                    Toast.makeText(OtpVerifyforSignup.this, "OTP is Incorrect", Toast.LENGTH_SHORT).show();
                }
    ...
    private void startSMSListener() {
        try {
            ...
            smsReceiver.setOTPListener(OtpVerifyforSignup.this);
