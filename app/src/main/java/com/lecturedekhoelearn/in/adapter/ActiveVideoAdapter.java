...
public class ActiveVideoAdapter extends RecyclerView.Adapter<ActiveVideoAdapter.MyViewHolder> {
    Context context;
    MyViewHolder myViewHolder;
    LayoutInflater inflater;
    ArrayList<ActiveVideoModelDetails> packageVideoDetailsModelArrayList;

    SharedPreferences preferences;
    SharedPreferences.Editor editor;

    public ActiveVideoAdapter(Context context, ArrayList<ActiveVideoModelDetails> subVideos) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        final ActiveVideoModelDetails subVideo = packageVideoDetailsModelArrayList.get(i);
