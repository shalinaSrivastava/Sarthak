...
public class SearchVideoAdapter extends RecyclerView.Adapter<SearchVideoAdapter.MyViewHolder> {
    ...
    ArrayList<SearchVideoModel> packageVideoDetailsModelArrayList;

    SharedPreferences preferences;
    SharedPreferences.Editor editor;

    public SearchVideoAdapter(Context context, ArrayList<SearchVideoModel> subVideos) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        final SearchVideoModel subVideo = packageVideoDetailsModelArrayList.get(i);
