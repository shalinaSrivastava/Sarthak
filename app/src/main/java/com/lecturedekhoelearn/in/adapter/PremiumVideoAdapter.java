...
public class PremiumVideoAdapter extends RecyclerView.Adapter<PremiumVideoAdapter.MyViewHolder> {
    Context context;
    ...
    public PremiumVideoAdapter(Context context, ArrayList<TopicWiseVideoDetailsModel> subVideos) {
