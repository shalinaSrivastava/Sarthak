...
import com.lecturedekhoelearn.in.activity.ScholarshipDetailsActivity;
...
public class ScholarshipAdapter extends RecyclerView.Adapter<ScholarshipAdapter.MyViewHolder> {
    ...
    public ScholarshipAdapter(Context context, ArrayList<ScholarShipModelDetails> teacherListDetailsModels) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.teacher_card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, ScholarshipDetailsActivity.class);
