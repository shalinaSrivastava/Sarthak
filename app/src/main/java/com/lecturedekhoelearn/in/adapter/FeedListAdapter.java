...
import com.lecturedekhoelearn.in.activity.FeedImageView;
...
public class FeedListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       String date=item.getTimeStamp();
        ...
        // user profile pic
        profilePic.setImageUrl(newspath+item.getProfilePic(), imageLoader);

        // Feed image
        if (item.getImge() != null) {
            feedImageView.setImageUrl(newspath+item.getImge(), imageLoader);
